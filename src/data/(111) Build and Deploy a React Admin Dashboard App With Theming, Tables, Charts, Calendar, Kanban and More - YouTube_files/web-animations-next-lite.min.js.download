...
this._rejectReadyPromise=function(){h({type:DOMException.ABORT_ERR,name:"AbortError"})}}.bind(this)),this.playState!=="pending"&&this._resolveReadyPromise());return this._readyPromise},get onfinish(){return this._animation.onfinish},set onfinish(f){this._animation.onfinish=typeof f=="function"?function(h){h.target=this;f.call(this,h)}.bind(this):f},get oncancel(){return this._animation.oncancel},set oncancel(f){this._animation.oncancel=typeof f=="function"?function(h){h.target=this;f.call(this,h)}.bind(this):
...
this._removeChildAnimations();this._updatePromises()},reverse:function(){this._updatePromises();var f=this.currentTime;this._animation.reverse();this._forEachChild(function(h){h.reverse()});f!==null&&(this.currentTime=f);this._updatePromises()},addEventListener:function(f,h){var d=h;typeof h=="function"&&(d=function(a){a.target=this;h.call(this,a)}.bind(this),h._wrapper=d);this._animation.addEventListener(f,d)},removeEventListener:function(f,h){this._animation.removeEventListener(f,h&&h._wrapper||
h)},_removeChildAnimations:function(){for(;this._childAnimations.length;)this._childAnimations.pop().cancel()},_forEachChild:function(f){var h=0;this.effect.children&&this._childAnimations.length<this.effect.children.length&&this._constructChildAnimations();this._childAnimations.forEach(function(c){f.call(this,c,h);this.effect instanceof window.SequenceEffect&&(h+=c.effect.activeDuration)}.bind(this));if(this.playState!="pending"){var d=this.effect._timing,a=this.currentTime;a!==null&&(a=y.calculateIterationProgress(y.calculateActiveDuration(d),
a,d));(a==null||isNaN(a))&&this._removeChildAnimations()}}};window.Animation=v.Animation})(G,L,null);(function(y,v,k){function f(e){this._frames=y.normalizeKeyframes(e)}function h(){for(var e=!1;b.length;)b.shift()._updateChildren(),e=!0;return e}var d=function(e){e._animation=void 0;if(e instanceof window.SequenceEffect||e instanceof window.GroupEffect)for(var m=0;m<e.children.length;m++)d(e.children[m])};v.removeMulti=function(e){for(var m=[],n=0;n<e.length;n++){var l=e[n];l._parent?(m.indexOf(l._parent)==
-1&&m.push(l._parent),l._parent.children.splice(l._parent.children.indexOf(l),1),l._parent=null,d(l)):l._animation&&l._animation.effect==l&&(l._animation.cancel(),l._animation.effect=new KeyframeEffect(null,[]),l._animation._callback&&(l._animation._callback._animation=null),l._animation._rebuildUnderlyingAnimation(),d(l))}for(n=0;n<m.length;n++)m[n]._rebuild()};v.KeyframeEffect=function(e,m,n,l){this.target=e;this._parent=null;n=y.numericTimingToObject(n);this._timingInput=y.cloneTimingInput(n);
this._timing=y.normalizeTimingInput(n);this.timing=y.makeTiming(n,!1,this);this.timing._effect=this;typeof m=="function"?(y.deprecated("Custom KeyframeEffect","2015-06-22","Use KeyframeEffect.onsample instead."),this._normalizedKeyframes=m):this._normalizedKeyframes=new f(m);this._keyframes=m;this.activeDuration=y.calculateActiveDuration(this._timing);this._id=l;return this};v.KeyframeEffect.prototype={getFrames:function(){return typeof this._normalizedKeyframes=="function"?this._normalizedKeyframes:
this._normalizedKeyframes._frames},set onsample(e){if(typeof this.getFrames()=="function")throw Error("Setting onsample on custom effect KeyframeEffect is not supported.");this._onsample=e;this._animation&&this._animation._rebuildUnderlyingAnimation()},get parent(){return this._parent},clone:function(){if(typeof this.getFrames()=="function")throw Error("Cloning custom effects is not supported.");var e=new KeyframeEffect(this.target,[],y.cloneTimingInput(this._timingInput),this._id);e._normalizedKeyframes=
this._normalizedKeyframes;e._keyframes=this._keyframes;return e},remove:function(){v.removeMulti([this])}};var a=Element.prototype.animate;Element.prototype.animate=function(e,m){var n="";m&&m.id&&(n=m.id);return v.timeline._play(new v.KeyframeEffect(this,e,m,n))};var c=document.createElementNS("http://www.w3.org/1999/xhtml","div");v.newUnderlyingAnimationForKeyframeEffect=function(e){if(e){var m=e.target||c,n=e._keyframes;typeof n=="function"&&(n=[]);var l=e._timingInput;l.id=e._id}else m=c,n=[],
l=0;return a.apply(m,[n,l])};v.bindAnimationForKeyframeEffect=function(e){e.effect&&typeof e.effect._normalizedKeyframes=="function"&&v.bindAnimationForCustomEffect(e)};var b=[];v.awaitStartTime=function(e){e.startTime===null&&e._isGroup&&(b.length==0&&requestAnimationFrame(h),b.push(e))};var g=window.getComputedStyle;Object.defineProperty(window,"getComputedStyle",{configurable:!0,enumerable:!0,value:function(){v.timeline._updateAnimationsPromises();var e=g.apply(this,arguments);h()&&(e=g.apply(this,
arguments));v.timeline._updateAnimationsPromises();return e}});window.KeyframeEffect=v.KeyframeEffect;window.Element.prototype.getAnimations=function(){return document.timeline.getAnimations().filter(function(e){return e.effect!==null&&e.effect.target==this}.bind(this))}})(G,L,null);(function(y,v,k){function f(b){b._registered||(b._registered=!0,a.push(b),c||(c=!0,requestAnimationFrame(h)))}function h(b){b=a;a=[];b.sort(function(g,e){return g._sequenceNumber-e._sequenceNumber});b=b.filter(function(g){g();
var e=g._animation?g._animation.playState:"idle";e!="running"&&e!="pending"&&(g._registered=!1);return g._registered});a.push.apply(a,b);a.length?(c=!0,requestAnimationFrame(h)):c=!1}document.createElementNS("http://www.w3.org/1999/xhtml","div");var d=0;v.bindAnimationForCustomEffect=function(b){var g=b.effect.target,e=typeof b.effect.getFrames()=="function";var m=e?b.effect.getFrames():b.effect._onsample;var n=b.effect.timing,l=null;n=y.normalizeTimingInput(n);var r=function(){var t=r._animation?
r._animation.currentTime:null;t!==null&&(t=y.calculateIterationProgress(y.calculateActiveDuration(n),t,n),isNaN(t)&&(t=null));t!==l&&(e?m(t,g,b.effect):m(t,b.effect,b.effect._animation));l=t};r._animation=b;r._registered=!1;r._sequenceNumber=d++;b._callback=r;f(r)};var a=[],c=!1;v.Animation.prototype._register=function(){this._callback&&f(this._callback)}})(G,L,null);(function(y,v,k){function f(d){return d._timing.delay+d.activeDuration+d._timing.endDelay}function h(d,a,c){this._id=c;this._parent=
null;this.children=d||[];this._reparent(this.children);a=y.numericTimingToObject(a);this._timingInput=y.cloneTimingInput(a);this._timing=y.normalizeTimingInput(a,!0);this.timing=y.makeTiming(a,!0,this);this.timing._effect=this;this._timing.duration==="auto"&&(this._timing.duration=this.activeDuration)}window.SequenceEffect=function(){h.apply(this,arguments)};window.GroupEffect=function(){h.apply(this,arguments)};h.prototype={_isAncestor:function(d){for(var a=this;a!==null;){if(a==d)return!0;a=a._parent}return!1},
_rebuild:function(){for(var d=this;d;)d.timing.duration==="auto"&&(d._timing.duration=d.activeDuration),d=d._parent;this._animation&&this._animation._rebuildUnderlyingAnimation()},_reparent:function(d){v.removeMulti(d);for(var a=0;a<d.length;a++)d[a]._parent=this},_putChild:function(d,a){for(var c=a?"Cannot append an ancestor or self":"Cannot prepend an ancestor or self",b=0;b<d.length;b++)if(this._isAncestor(d[b]))throw{type:DOMException.HIERARCHY_REQUEST_ERR,name:"HierarchyRequestError",message:c};
for(b=0;b<d.length;b++)a?this.children.push(d[b]):this.children.unshift(d[b]);this._reparent(d);this._rebuild()},append:function(){this._putChild(arguments,!0)},prepend:function(){this._putChild(arguments,!1)},get parent(){return this._parent},get firstChild(){return this.children.length?this.children[0]:null},get lastChild(){return this.children.length?this.children[this.children.length-1]:null},clone:function(){for(var d=y.cloneTimingInput(this._timingInput),a=[],c=0;c<this.children.length;c++)a.push(this.children[c].clone());
...
Math.max(d,f(a))});return d}});v.newUnderlyingAnimationForGroup=function(d){var a,c=null;d=new KeyframeEffect(null,[],d._timing,d._id);d.onsample=function(b){var g=a._wrapper;g&&g.playState!="pending"&&g.effect&&(b==null?g._removeChildAnimations():b==0&&g.playbackRate<0&&(c||(c=y.normalizeTimingInput(g.effect.timing)),b=y.calculateIterationProgress(y.calculateActiveDuration(c),-1,c),isNaN(b)||b==null)&&(g._forEachChild(function(e){e.currentTime=-1}),g._removeChildAnimations()))};return a=v.timeline._play(d)};
